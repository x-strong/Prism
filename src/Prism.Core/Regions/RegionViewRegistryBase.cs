...
namespace Prism.Regions
{
    ...
    /// </summary>
    public abstract class RegionViewRegistryBase : IRegionViewRegistry
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="IRegionViewRegistry"/> class.
        /// </summary>
        /// <param name="container"><see cref="IContainerExtension"/> used to create the instance of the views from its <see cref="Type"/>.</param>
        protected RegionViewRegistryBase(IContainerExtension container)
        {
        ...
        protected virtual object CreateInstance(Type type)
        {
            ...
            AutowireViewModel(view);
            return view;
        }

        /// <summary>
        /// Calls the platform AutowireViewModel on the created view
        /// </summary>
        /// <param name="view"></param>
        protected abstract void AutowireViewModel(object view);
